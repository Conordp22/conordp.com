...
final class thesis_admin {
	...
	public function menu() {
		...
		add_submenu_page('thesis', __('Thesis HTML Head Editor', 'thesis'), __('Head Editor', 'thesis'), 'edit_theme_options', 'admin.php?page=thesis&canvas=head'); #wp
		add_submenu_page('thesis', __('Thesis Skin Editor', 'thesis'), __('Skin Editor', 'thesis'), 'edit_theme_options', 'admin.php?page=thesis&canvas=skin-editor-quicklaunch&_wpnonce=' . wp_create_nonce('thesis-skin-editor-quicklaunch')); #wp
	}
	...
	private function bubble_tips() {
		...
		$tips = array(
			...
			'category-seo' => array(
				...
				'author' => 'pearsonified'),
			'404page' => array(
				'tip' => sprintf(__('Thesis lets you control the content of your 404 page. All you have to do is <a href="%s">specify a 404 page</a>, and boom&#8212;it&#8217;s like magic!', 'thesis'), admin_url('admin.php?page=thesis&canvas=404page')),
				'author' => 'missieur'),
			'typography' => array(
			...
			'updates' => array(
				...
				'author' => 'missieur'),
			'verify' => array(
				'tip' => sprintf(__('You like ranking in search engines, don&#8217;t ya? Then be sure to verify your site with both Google and Bing Webmaster Tools on the <a href="%s">Tracking Scripts page.</a>', 'thesis'), admin_url('admin.php?page=thesis&canvas=tracking')),
				'author' => 'missieur'),
			'march-2008' => array(
	...
	private function upgrade_meta() {
		...
		// only get the ones that actually *have* thesis metas
		...
		*/
		...
		foreach ($metas as $results) {
			...
			if (isset($or[$results['meta_key']]['additional']))
				...
				// results = array(post_id, meta_key, meta_value)
