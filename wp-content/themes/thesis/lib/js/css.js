...
thesis_css = {
	init: function() {
		...
		$('#t_create_var').click(function() { thesis_css.variable.edit({ id: 'new' }); });
		$('.t_css_input').keyup(function() { thesis_css.css(); });
		$('#t_save_css').click(function() {
			if (confirm('Are you sure you want to save your CSS and compile new Thesis stylesheets?')) thesis_css.save();
			return false;
		});
	},
